...
async function seed() {
  try {
    ...
    const users = await User.bulkCreate([
      { openid: 'seed_u001', nick_name: '小王妈妈', avatar_url: 'https://api.dicebear.com/7.x/adventurer/svg?seed=mama', building: '3栋1单元', credit_score: 180, is_verified: true },
      { openid: 'seed_u002', nick_name: '老张', avatar_url: 'https://api.dicebear.com/7.x/adventurer/svg?seed=zhang', building: '7栋2单元', credit_score: 220, is_verified: true },
      { openid: 'seed_u003', nick_name: '数码小哥', avatar_url: 'https://api.dicebear.com/7.x/adventurer/svg?seed=digi', building: '12栋', credit_score: 150, is_verified: true },
      { openid: 'seed_u004', nick_name: '爱做饭的李姐', avatar_url: 'https://api.dicebear.com/7.x/adventurer/svg?seed=lijie', building: '5栋3单元', credit_score: 195, is_verified: true },
      { openid: 'seed_u005', nick_name: '健身达人阿凯', avatar_url: 'https://api.dicebear.com/7.x/adventurer/svg?seed=fitness', building: '9栋1单元', credit_score: 160, is_verified: true },
      { openid: 'seed_u006', nick_name: '6栋王大姐', avatar_url: 'https://api.dicebear.com/7.x/adventurer/svg?seed=wang6', building: '6栋1单元', credit_score: 210, is_verified: true },
      { openid: 'seed_u007', nick_name: '遛狗小分队队长', avatar_url: 'https://api.dicebear.com/7.x/adventurer/svg?seed=dogwalk', building: '8栋', credit_score: 175, is_verified: true },
      { openid: 'seed_u008', nick_name: '新搬来的小陈', avatar_url: 'https://api.dicebear.com/7.x/adventurer/svg?seed=chen', building: '2栋', credit_score: 100, is_verified: true },
      { openid: 'seed_u009', nick_name: '10栋小赵', avatar_url: 'https://api.dicebear.com/7.x/adventurer/svg?seed=zhao', building: '10栋2单元', credit_score: 135, is_verified: true },
      { openid: 'seed_u010', nick_name: '物业管理处', avatar_url: 'https://api.dicebear.com/7.x/adventurer/svg?seed=prop', building: '', credit_score: 300, is_verified: true },
      { openid: 'seed_u011', nick_name: '房东刘先生', avatar_url: 'https://api.dicebear.com/7.x/adventurer/svg?seed=landlord', building: '8栋', credit_score: 140, is_verified: true },
      { openid: 'seed_u012', nick_name: '合租小伙伴小美', avatar_url: 'https://api.dicebear.com/7.x/adventurer/svg?seed=xiaomei', building: '2栋', credit_score: 110, is_verified: true },
      { openid: 'seed_u013', nick_name: '退休周叔', avatar_url: 'https://api.dicebear.com/7.x/adventurer/svg?seed=zhoushu', building: '1栋', credit_score: 250, is_verified: true },
      { openid: 'seed_u014', nick_name: '程序员小林', avatar_url: 'https://api.dicebear.com/7.x/adventurer/svg?seed=coder', building: '12栋3单元', credit_score: 120, is_verified: true },
      { openid: 'seed_u015', nick_name: '瑜伽姐姐', avatar_url: 'https://api.dicebear.com/7.x/adventurer/svg?seed=yoga', building: '5栋1单元', credit_score: 165, is_verified: true }
    ]);
